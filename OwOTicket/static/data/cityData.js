export const regionData = [
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '齐齐哈尔市', districts: ['龙沙区', '建华区', '铁锋区', '昂昂溪区', '富拉尔基区'] },
  ...
  },
  {
    name: '浙江省',
    cities: [
      { name: '杭州市', districts: ['上城区', '下城区', '江干区', '拱墅区', '西湖区', '滨江区', '萧山区', '余杭区', '富阳区'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '嘉峪关市', districts: ['市辖区'] },
      { name: '金昌市', districts: ['金川区', '永昌区'] }
    ]
  },
  {
    name: '青海省',
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '高雄市', districts: ['盐埕区', '鼓山区', '左营区', '楠梓区', '三民区', '新兴区', '前金区', '苓雅区', '前镇区', '旗津区', '小港区', '凤山区', '林园区', '大寮区', '大树区'] }
    ]
  },
  {
    name: '广西省',
    ...
    cities: [
      {
        ...
        districts: [
          ...
          '九龙城区', '黄大仙区', '观塘区', '荃湾区', '屯门区',
          '元朗区', '北区', '大埔区', '西贡区', '沙田区', '葵青区', '离岛区'
        ]
      }
    ]
  },
